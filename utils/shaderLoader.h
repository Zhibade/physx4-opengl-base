...
public:
    ...
    /* Loads passed vertex and fragment shaders, create a program and use them */
    void loadShaders(const char* vertShaderContents, const char* fragShaderContents);

    /* Sets a 4x4 Matrix property on the current shader */
    void setMat4(const std::string &name, const glm::mat4 &mat);

    /* Sets a Vec3 property on the current shader */
    void setVec3(const std::string &name, const glm::vec3 &vec);

    /* Sets a Vec4 property on the current shader */
